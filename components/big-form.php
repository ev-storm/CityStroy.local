			...
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide btnSlide">
					<form class="big-form" action="#" method="POST" enctype="multipart/form-data">
						...
						<div class="form-section"><h1 class="form-title">Что вас интересует?</h1>
							<div class="input-form-ban">
								<label>
									<input name="Что&nbsp;интересует&nbsp;" value="Строительство объекта 'под ключ'" type="checkbox" checked/>
									<span>Строительство объекта "под ключ"</span>
								</label>
							</div>
							<div class="input-form-ban">
								<label>
									<input name="Что&nbsp;интересует&nbsp;&nbsp;" value="Дизайн интерьера" type="checkbox" />
									<span>Дизайн интерьера</span>
								</label>
							</div>
							<div class="input-form-ban">
								<label>
									<input name="Что&nbsp;интересует&nbsp;&nbsp;&nbsp;" value="Ремонт и строительно-монтажные работы" type="checkbox" />
									<span>Ремонт и строительно-монтажные работы</span>
								</label>
							</div>
							<div class="che input-form-ban">
								<label>
									<input name="Что&nbsp;интересует&nbsp;&nbsp;&nbsp;&nbsp;" value="Проектирование технологии (кухни)" type="checkbox" />
									<span>Проектирование технологии (кухни)</span>
								</label>
							</div>
							<div class="che input-form-ban">
								<label>
									<input class="input" name="Что&nbsp;интересует&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" value="Инженерное проектирование " type="checkbox" />
				...
				<div class="swiper-slide btnSlide">
						...
						<div class="form-section"><h1 class="form-title">Укажите площадь помещения м&#178</h1>
							<input type="number" class="input-form-ban" id="number-P" value="250" name="Площадь&nbsp;помещения"/>
							<input  type="range" class="input-form-ban" id="range-P" value="250" name="Площадь&nbsp;помещения" min="0" max="500"/>
						</div>
						<div class="form-section"><h1 class="form-title">Укажите высоту потолков м&#178</h1>
							<input type="number" class="input-form-ban" id="number-H" value="2.5" name="Высота&nbsp;потолков"/>
							<input type="range" class="input-form-ban" id="range-H" value="2.5" step="0.1" name="Высота&nbsp;потолков" min="0" max="5"/>
						</div>
				...
				<div class="swiper-slide btnSlide">
					...
					<div class="form-section"><h1 class="form-title">Где территориально расположено помещение?</h1>
							<div class="input-form-ban">
								<label>
									<input name="Территориальное&nbsp;расположение" value="Москва, в пределах МКАД" type="radio" checked/>
									<span>Москва, в пределах МКАД</span>
								</label>
							</div>
							<div class="input-form-ban">
								<label>
									<input name="Территориальное&nbsp;расположение" value="Москва, за пределом МКАД" type="radio" />
					...
					<div class="form-section"><h1 class="form-title">Какое заведение планируется открыть?</h1>
						<div class="res-form">
							...
							<div class="input-form-ban">
								<label>
									<input name="Тип&nbsp;заведения" type="text" class="over-res-in input modal__input input-name" placeholder="Тип заведения">
								</label>
							</div>
						</div>
					</div>
					...
					<div class="form-section"><h1 class="form-title">Укажите предполагаемое количество посадочных мест</h1>
							<input type="number" class="input-form-ban" id="number-M" value="200" name="Количество&nbsp;посадочных мест"/>
							<input type="range" class="input-form-ban" id="range-M" value="200"  name="Количество&nbsp;посадочных мест" min="0" max="500"/>
					</div>
				...
				<div class="form-section"><h1 class="form-title">Заведение планируется открыть по франшизе?</h1>
					...
					<div class="form-section"><h1 class="form-title">Какие разделы необходимы в проекте?</h1>
						...
						<div class="input-form-ban">
							<label>
								<input name="Необходимые&nbsp;разделы&nbsp;проекта" value="Спецификация и расстановка технологического оборудования" type="checkbox" checked/>
								<span>Спецификация и расстановка технологического оборудования</span>
							</label>
						</div>
						<div class="input-form-ban">
							<label>
								<input name="Необходимые&nbsp;разделы&nbsp;проекта&nbsp;" value="Водоснабжение, канализация, вентиляция, электроснабжение" type="checkbox" checked/>
								<span>Водоснабжение, канализация, вентиляция, электроснабжение</span>
							</label>
						</div>
						<div class="input-form-ban">
							<label>
								<input name="Необходимые&nbsp;разделы&nbsp;проекта&nbsp;&nbsp;" value="Отделка стен, полов и потолков" type="checkbox" checked/>
